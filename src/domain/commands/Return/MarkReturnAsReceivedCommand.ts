...
export default async function MarkReturnAsReceivedCommand(uuid: string, returnBy: Date) {
    ...
    await ConnectionHelper.UpdateOne<Return>("return", { uuid }, { $set: { status: ReturnStatus.ItemReceived, returnBy } });
}